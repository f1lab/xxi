...
class InvoiceForm extends BaseInvoiceForm
{
  public function configure()
  {
    $this->getWidgetSchema()
      ...
      ->offsetSet('number', new sfWidgetFormInputText(array(),array('type' => 'number', 'step' => '0.01', 'min' => '0', 'class' => 'invoice-number')))
      ->offsetSet('price', new sfWidgetFormInputText(array(),array('type' => 'number', 'step' => '0.01', 'min' => '0', 'class' => 'invoice-price')))
      ->offsetSet('sum', new sfWidgetFormInputText(array(),array('type' => 'number', 'step' => '0.01', 'min' => '0', 'disabled' => true, 'title' => 'Вычисляется автоматически при сохранении', 'class' => 'invoice-sum')));
