...
<?php endif ?>
  <div class="btn-group">
    <select name="" id="" style="float:left;margin-bottom:0" onchange="document.location.href = '<?php echo url_for('@contractors') ?>/' + $(this).val()" class="chzn-select" data-placeholder="Быстрый переход">
      <option value=""></option>
...
<table class="table table-condensed table-bordered rows-clickable">
  ...
  <tr>
    ...
    <td><a href="<?php echo url_for('@contractor?id=' . $client->getId()) ?>"><?php echo $client->getName() ?></a></td>
