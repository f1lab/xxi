...
<div class="row">
  ...
  <div class="span4"><?php if ($sf_user->hasGroup('director') or $sf_user->hasCredential('can_edit_contractors')): ?>
    <a href="<?php echo url_for('@contractor-edit?id=' . $client->getId()) ?>" class="btn">Редактировать</a>
  <?php endif ?></div>
</div>
