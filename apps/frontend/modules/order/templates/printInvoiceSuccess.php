 ...
 margin;mso-table-left:left;mso-table-top:6.75pt;mso-padding-alt:0cm 5.4pt 0cm 5.4pt'>
  ...
  mso-fareast-language:RU'>Счет-фактура № <?php echo $order->getWaybillNumber() ?> от <?php
                            ...
                            echo(date("d", strtotime($order->getSubmitedAt())) . " " . $monthes[date('n',
                                    strtotime($order->getSubmitedAt()))] . date(' Y',
                                    strtotime($order->getSubmitedAt())));
                            ?> г.<o:p></o:p></span></b></p>
            </td>
  ...
  mso-fareast-language:RU'>Продавец: <?php echo $company->getFullName() ?>
                        <o:p></o:p></span></p>
            </td>
        </tr>
  ...
  mso-element-top:6.75pt;mso-height-rule:exactly'><span style='font-size:8.0pt;
  font-family:"Arial","sans-serif";mso-fareast-font-family:"Times New Roman";
  mso-fareast-language:RU'>Адрес: <?php echo $company->getAddressJure() ?>
                        <o:p></o:p></span></p>
            </td>
        </tr>
  ...
  mso-element-top:6.75pt;mso-height-rule:exactly'><span style='font-size:8.0pt;
  font-family:"Arial","sans-serif";mso-fareast-font-family:"Times New Roman";
  mso-fareast-language:RU'>ИНН/КПП продавца: <?php echo $company->getInn() ?>/<?php echo $company->getKpp() ?>
                        <o:p></o:p></span></p>
            </td>
        </tr>
  ...
  mso-element-top:6.75pt;mso-height-rule:exactly'><span style='font-size:8.0pt;
  font-family:"Arial","sans-serif";mso-fareast-font-family:"Times New Roman";
  mso-fareast-language:RU'>Грузополучатель и его адрес: <?php echo $order->getClient()->getFullName() . ", "
                            . $order->getClient()->getAddressJure() ?>
                        <o:p></o:p></span></p>
            </td>
        </tr>
  ...
  mso-element-top:6.75pt;mso-height-rule:exactly'><span style='font-size:8.0pt;
  font-family:"Arial","sans-serif";mso-fareast-font-family:"Times New Roman";
  mso-fareast-language:RU'>Покупатель: <?php echo $order->getClient()->getFullName() ?>
                        <o:p></o:p></span></p>
            </td>
        </tr>
  ...
  mso-element-top:6.75pt;mso-height-rule:exactly'><span style='font-size:8.0pt;
  font-family:"Arial","sans-serif";mso-fareast-font-family:"Times New Roman";
  mso-fareast-language:RU'>Адрес: <?php echo $order->getClient()->getAddressJure() ?>
                        <o:p></o:p></span></p>
            </td>
        </tr>
  ...
  mso-element-top:6.75pt;mso-height-rule:exactly'><span style='font-size:8.0pt;
  font-family:"Arial","sans-serif";mso-fareast-font-family:"Times New Roman";
  mso-fareast-language:RU'>ИНН/КПП покупателя:<?php echo " " . $order->getClient()->getInn() . "/" . $order->getClient()
                                ->getKpp() ?>
                        <o:p></o:p></span></p>
            </td>
        </tr>
  ...
  mso-element-top:6.75pt;mso-height-rule:exactly'><span style='font-size:8.0pt;
  font-family:"Arial","sans-serif";mso-fareast-font-family:"Times New Roman";
  mso-fareast-language:RU'><?php echo $invoice->getDescription() ?>
                            <o:p></o:p></span></p>
                </td>
  ...
  margin;mso-element-top:6.75pt;mso-height-rule:exactly'><span
                                style='font-size:8.0pt;font-family:"Arial","sans-serif";mso-fareast-font-family:
  "Times New Roman";mso-fareast-language:RU'><?php echo number_format($invoice->getNumber(), 3, ',', ' ') ?>
                            <o:p></o:p></span></p>
                </td>
  ...
  margin;mso-element-top:6.75pt;mso-height-rule:exactly'><span
                                style='font-size:8.0pt;font-family:"Arial","sans-serif";mso-fareast-font-family:
  "Times New Roman";mso-fareast-language:RU'><?php echo number_format($invoice->getPrice(), 2, ',', ' ') ?>
                            <o:p></o:p></span></p>
                </td>
  ...
  "Times New Roman";mso-fareast-language:RU'><?php echo
                            number_format(($invoice->getPrice() * $invoice->getNumber()), 2, ',', ' '); ?>
                            <o:p></o:p></span></p>
                </td>
  ...
  margin;mso-element-top:6.75pt;mso-height-rule:exactly'><span
                                style='font-size:8.0pt;font-family:"Arial","sans-serif";mso-fareast-font-family:
  "Times New Roman";mso-fareast-language:RU'><?php echo number_format(($invoice->getSum() * 18 / 118), 2, ',', ' '); ?>
                            <o:p></o:p></span></p>
                </td>
  ...
  margin;mso-element-top:6.75pt;mso-height-rule:exactly'><span
                                style='font-size:8.0pt;font-family:"Arial","sans-serif";mso-fareast-font-family:
  "Times New Roman";mso-fareast-language:RU'><?php echo number_format($invoice->getSum(), 2, ',', ' ') ?>
                            <o:p></o:p></span></p>
                </td>
  ...
  margin;mso-element-top:6.75pt;mso-height-rule:exactly'><span
                            style='font-size:8.0pt;font-family:"Arial","sans-serif";mso-fareast-font-family:
  "Times New Roman";mso-fareast-language:RU'><?php echo number_format($sumclear, 2, ',', ' ') ?>
                        <o:p></o:p></span></p>
            </td>
  ...
  margin;mso-element-top:6.75pt;mso-height-rule:exactly'><span
                            style='font-size:8.0pt;font-family:"Arial","sans-serif";mso-fareast-font-family:
  "Times New Roman";mso-fareast-language:RU'><?php echo number_format($ndssum, 2, ',', ' ') ?>
                        <o:p></o:p></span></p>
            </td>
  ...
  margin;mso-element-top:6.75pt;mso-height-rule:exactly'><span
                            style='font-size:8.0pt;font-family:"Arial","sans-serif";mso-fareast-font-family:
  "Times New Roman";mso-fareast-language:RU'><?php echo number_format($ndssum + $sumclear, 2, ',', ' ') ?>
                        <o:p></o:p></span></p>
            </td>
            <td width=65 nowrap valign=bottom style='width:49.0pt;padding:0cm 5.4pt 0cm 5.4pt;
  height:11.4pt'></td>
...
<div class="print-options">
    ...
    <ul id="c_tn" class="doc h" style="display: block;">
        <li><input class="hide-doc" type="checkbox" id="tn-929" checked="">№ <a href=""
                                                                                title="Счет-фактура"><?php echo $order->getWaybillNumber() ?></a><span>от
                <?php
