    ...
    <div class="tab-content">
        ...
        <form action="?report" method="post" class="well">
            ...
            <div class="control-group">
                <?php echo $form['client']->renderLabel(null, ['class' => 'control-label']) ?>
        ...
        <div class="alert alert-info">
            ...
            <?php if ($client and true == ($client = Doctrine_Core::getTable('Client')->find($client))): ?>
                по клиенту <strong><?php echo $client->getName() . ($client->getFullName() ? ' ('
                            . $client->getOwnershipTranslated() . ' «' . $client->getFullName() . '»)' : '') ?></strong>
            <?php else: ?>
