...
<div class="tabbable tabs-left">
    ...
    <div class="tab-content">
        ...
        <div class="alert alert-info">
            За период <strong><?php echo date('d.m.Y', strtotime($period['from'])) . '—' . date('d.m.Y',
                        strtotime($period['to'])) ?></strong>
        </div>
        <table class="table table-striped table-condensed">
            ...
            foreach ($report as $row):
                ...
                ?>
                <tr>
                    <td><a href="<?php echo url_for('@client?id=' . $row->getId()
                            . '&state=debt') ?>"><?php echo $row->getName() ?></a></td>
                    <td><?php $sumOrders += $row->getOrders()->count();
                        echo $row->getOrders()->count() ?></td>
                    <td><?php $sumCost += $ordersCost;
                        echo $ordersCost ?></td>
                    <td><?php $sumPayed += $payedSum;
                        echo $payedSum ?></td>
                    <td><?php $sumDebt += ($ordersCost - $payedSum);
                        echo($ordersCost - $payedSum) ?></td>
                </tr>
