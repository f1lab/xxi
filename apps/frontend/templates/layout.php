            ...
            <ul class="nav pull-right"><?php if ($sf_user->isAuthenticated()): ?>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <?php echo true == ($name = $sf_user->getName()) ? $name . ' (' . $sf_user->getUsername() . ')'
                            : $sf_user->getUsername() ?>
                        <b class="caret"></b>
                    </a>
                    <ul class="dropdown-menu">
                        <?php if ($sf_user->isSuperadmin() || $sf_user->hasGroup('diretor')
                            || $sf_user->hasGroup('buhgalter')
                        ): ?>
    ...
    <form action="#" method="post">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                ...
                <select name="dimension_id" id="dimension_id" class="input-block-level"><?php foreach ($dimensions as
                        $dimension): ?>
